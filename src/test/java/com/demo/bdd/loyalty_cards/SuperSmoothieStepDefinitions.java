package com.demo.bdd.loyalty_cards;
...
public class SuperSmoothieStepDefinitions {
    ...
    private MorningFreshnessMember morningFreshnessMember;
    ...
    public void michael_is_a_Morning_Freshness_Member(String name) {
        morningFreshnessMember = new MorningFreshnessMember(name, superSmoothieSchema);
    }
    ...
    public void michael_purchases_drinks(String name,
                                         Integer amount,
                                         String drink) {
        morningFreshnessMember.orders(amount, drink);
    }

    @Then("he should earn {int} points")
    public void he_should_earn_points(Integer expectedPoints) {
        assertThat(morningFreshnessMember.getPoints()).isEqualTo(expectedPoints);
    }
}
